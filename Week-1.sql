...
DELETE FROM PARTICIPATED WHERE (SELECT AVG (DAMAGE_AMOUNT) FROM participated);

SELECT NAME FROM PERSON A, PARTICIPATED B WHERE A.DRIVER_ID = B.DRIVER_ID AND (SELECT AVG(DAMAGE_AMOUNT) FROM PARTICIPATED);
